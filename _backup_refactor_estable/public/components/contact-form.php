    ...
    <section id="comentarios" class="py-16 md:py-24 bg-white">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                ...
                <p class="text-lg text-gray-600">La opini├│n de nuestra comunidad es muy importante para nosotros</p>
            </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    <div class="lg:col-span-1">
                        <div class="bg-white rounded-2xl shadow-xl p-6 border border-gray-200 sticky top-24">
                            <h3 class="text-2xl font-bold text-gray-900 mb-6 flex items-center"><i class="fas fa-comment-dots text-primary-500 mr-2"></i>Env├¡a tu Comentario</h3>
                            <?php if ($user): ?>
                            <form action="<?= htmlspecialchars(app_base_url()) ?>/public/index.php?page=comments/save" method="POST" class="space-y-4" id="comment-form">
                                ...
                                <div>
                                    <label class="block text-sm font-semibold text-gray-700 mb-2">Calificaci├│n (opcional)</label>
                                ...
                                <div>
                                    ...
                                    <textarea name="contenido" rows="5" required placeholder="Escribe tu comentario aqu├¡..." class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent"></textarea>
                                </div>
                            ...
                            <div class="text-center py-8">
                                ...
                                <p class="text-gray-600 mb-4">Debes iniciar sesi├│n para publicar comentarios</p>
                                <a href="login.php?redirect=landing.php%23comentarios" class="inline-block bg-primary-500 text-white px-6 py-3 rounded-lg font-semibold hover:bg-primary-600 transition-all"><i class="fas fa-sign-in-alt mr-2"></i>Iniciar Sesi├│n</a>
                            </div>
                            <?php endif; ?>
                        </div>
                    </div>
                    <div class="lg:col-span-2">
                        ...
                        <div class="bg-white rounded-2xl shadow-lg p-12 text-center border border-gray-200">
                            ...
                            <h3 class="text-2xl font-bold text-gray-900 mb-2">No hay comentarios a├║n</h3>
                            <p class="text-gray-600 mb-6">S├® el primero en compartir tu opini├│n con la comunidad.</p>
                            <?php if (!$user): ?><a href="login.php?redirect=landing.php%23comentarios" class="inline-block bg-gradient-to-r from-primary-500 to-primary-700 text-white px-6 py-3 rounded-lg font-semibold hover:from-primary-600 hover:to-primary-800 transition-all"><i class="fas fa-sign-in-alt mr-2"></i>Iniciar Sesi├│n para Comentar</a><?php endif; ?>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
