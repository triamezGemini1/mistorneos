<?php
/**
 * Men├║ de Anclaje R├ípido - Navegaci├│n lateral flotante con iconos
...
$side_nav_sections = [
    ...
    ['id' => 'galeria', 'icon' => 'fa-images', 'label' => 'Galer├¡a'],
...
?>
<nav id="side-nav" class="fixed right-3 top-1/2 -translate-y-1/2 flex flex-col gap-2 rounded-2xl p-2 shadow-2xl border border-[#38a169]" style="background-color: #48bb78; z-index: 9999;" aria-label="Anclaje r├ípido">
