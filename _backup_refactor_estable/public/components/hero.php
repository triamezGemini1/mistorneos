<?php
/**
 * Componente Hero - Secci├│n principal de bienvenida (layout compacto)
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center min-h-[calc(100vh-8rem)]">
                ...
                <div class="order-2 lg:order-1 text-center lg:text-left">
                    <h1 class="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 leading-tight">
                        Bienvenido a<br>
                        <span class="text-accent"><?= htmlspecialchars($SITE_NAME ?? 'mistorneos', ENT_QUOTES, 'UTF-8') ?></span>
                    </h1>
                    <p class="text-base md:text-lg lg:text-xl mb-6 text-white/90 leading-relaxed max-w-xl mx-auto lg:mx-0">
                        La plataforma integral para la gesti├│n de torneos de domin├│ en Venezuela.
                        Participa en eventos cerca de ti o ├║nete como organizador.
                    </p>
                    <div class="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start">
                        ...
                        <a href="<?= htmlspecialchars($pp . 'dashboard.php', ENT_QUOTES, 'UTF-8') ?>" class="inline-flex items-center justify-center px-6 py-3 bg-white/10 backdrop-blur-sm text-white font-semibold rounded-xl border-2 border-white/30 hover:bg-white hover:text-primary-700 transition-all duration-300">
                            <i class="fas fa-sign-in-alt mr-2"></i>Mi cuenta (jugador)
                        </a>
                    </div>
                </div>
                ...
                <div class="order-1 lg:order-2 flex justify-center lg:justify-end">
                    <div class="relative w-48 h-48 sm:w-64 sm:h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 flex items-center justify-center">
                        ...
                        <div class="relative w-full h-full flex items-center justify-center text-8xl font-black text-white/30 select-none" aria-hidden="true">M</div>
                    </div>
                </div>
            </div>
        </div>
