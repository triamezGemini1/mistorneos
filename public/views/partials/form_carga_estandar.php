...
/**
 * Modelo A: hasta 4 filas independientes (Individual / Equipos).
 *
...
$filas = $filas ?? [];
?>
<form id="mn-form-carga-estandar" class="mn-carga-res-form" method="post" action="carga_resultados.php" novalidate>
