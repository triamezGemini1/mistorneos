...
/**
 * Carga vinculada (tipo_torneo = parejas): 2 bloques, mismos valores replicados a 2 filas partiresul por pareja al guardar.
 *
...
$tituloPareja1 = 'Pareja 1';
$tituloPareja2 = 'Pareja 2';
$n1a = $nomA($a) !== '' ? $nomA($a) : 'Jugador A';
$n1b = $nomA($b) !== '' ? $nomA($b) : 'Jugador B';
$n2a = $nomA($c) !== '' ? $nomA($c) : 'Jugador C';
$n2b = $nomA($d) !== '' ? $nomA($d) : 'Jugador D';
$tituloPareja1 .= ' (' . $n1a . ' + ' . $n1b . ')';
$tituloPareja2 .= ' (' . $n2a . ' + ' . $n2b . ')';
?>
<form id="mn-form-carga-parejas" class="mn-carga-res-form mn-form-carga--vinculada" method="post" action="carga_resultados.php" novalidate>
  ...
  <div class="mn-carga-res-parejas">
    <section class="mn-carga-res-bloque mn-carga-res-bloque--a" aria-labelledby="mn-pareja-a">
      <h3 id="mn-pareja-a" class="mn-carga-res-bloque-title"><?= htmlspecialchars($tituloPareja1, ENT_QUOTES, 'UTF-8') ?></h3>
      <p class="mn-carga-res-bloque-hint mn-hint">Un solo puntaje para la dupla; se guarda igual en ambos jugadores.</p>
      ...
      <div class="mn-carga-res-bloque-fields">
        <label class="mn-label" for="puntos_pareja_a">Puntos de la pareja 1 (total de la dupla)</label>
        ...
        <label class="mn-label" for="sets_pareja_a">Sets de la pareja 1</label>
    ...
    <section class="mn-carga-res-bloque mn-carga-res-bloque--b" aria-labelledby="mn-pareja-b">
      <h3 id="mn-pareja-b" class="mn-carga-res-bloque-title"><?= htmlspecialchars($tituloPareja2, ENT_QUOTES, 'UTF-8') ?></h3>
      <p class="mn-carga-res-bloque-hint mn-hint">Un solo puntaje para la dupla; se guarda igual en ambos jugadores.</p>
      <p class="mn-carga-res-bloque-jug">
      ...
      <div class="mn-carga-res-bloque-fields">
        <label class="mn-label" for="puntos_pareja_b">Puntos de la pareja 2 (total de la dupla)</label>
        ...
        <label class="mn-label" for="sets_pareja_b">Sets de la pareja 2</label>
