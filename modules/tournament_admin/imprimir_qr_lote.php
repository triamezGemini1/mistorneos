...
<div class="card">
    ...
    <div class="card-body">
        ...
        <?php else: ?>
            <p class="small text-muted mb-3 no-print-lote">Tarjetas 8×8 cm: nombre, cédula, ID jugador. 5 columnas × 6 filas por hoja. Al imprimir solo se muestran las tarjetas.</p>
