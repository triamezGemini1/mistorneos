...
// Obtener invitaciones activas disponibles
$invitations = [];
try {
    $stmt = DB::pdo()->query("
        ...
        WHERE i.estado = 0 
        AND NOW() BETWEEN i.acceso1 AND i.acceso2
        ORDER BY i.id DESC
    ");
...
<div class="fade-in">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mb-0">Seleccione una invitación para acceder al formulario de registro</p>
        </div>
        <div>
    ...
    <?php if (empty($invitations)): ?>
        ...
        <div class="card">
            <div class="card-body text-center py-5">
                ...
                <p class="text-muted">No se encontraron invitaciones con período de acceso activo.</p>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card h-100 border-primary">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        <h6 class="text-info">Información de Acceso:</h6>
                                        <p class="mb-1">
                                        ...
                                        <p class="mb-1">
                                            ...
                                            <strong>Contraseña:</strong> usuario
                                        </p>
                                    </div>
                                    
                                    <div class="mb-3">
                                        <h6 class="text-warning">Período de Acceso:</h6>
                                        <p class="mb-1">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <ol class="small">
                            <li>Seleccione una invitación de la lista</li>
                            <li>Acceda al formulario con las credenciales del club</li>
                            <li>Complete el formulario de registro de jugadores</li>
                            <li>Los jugadores quedarán inscritos automáticamente</li>
                        </ol>
                    </div>
                    <div class="col-md-6">
                        <h6 class="text-success">Credenciales de Acceso</h6>
                        <ul class="small">
                            <li><strong>Usuario:</strong> Campo "usuario" de la invitación</li>
                            <li><strong>Contraseña:</strong> "usuario" (para todos los clubes)</li>
                            <li><strong>Período:</strong> Solo durante las fechas de acceso</li>
                        </ul>
                    </div>
                </div>
            </div>
