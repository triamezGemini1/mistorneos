            ...
            .then(data => {
                ...
                if (data && data.success && data.data && data.data.encontrado) {
                    if (data.data.existe_usuario) {
                        ...
                        // Guardar sexo en campo oculto si está disponible
                        if (persona.sexo) {
                            ...
                            // Crear o actualizar campo oculto para sexo
                            let sexoInput = document.getElementById('sexo_hidden');
                            if (!sexoInput) {
                                sexoInput = document.createElement('input');
                                sexoInput.type = 'hidden';
                                sexoInput.id = 'sexo_hidden';
                                sexoInput.name = 'sexo';
                                document.querySelector('form').appendChild(sexoInput);
                            }
                            sexoInput.value = sexoValue;
                        }
