          ...
          <div class="card-body">
            ...
            <form method="POST">
              ...
              <div class="d-flex justify-content-between mb-3">
                <a class="small text-decoration-none fw-semibold" href="recover_user.php">
                  <i class="fas fa-user-circle me-1"></i>Recuperar usuario
                </a>
                <a class="small text-decoration-none fw-semibold" href="reset_password_no_email.php">
                  <i class="fas fa-key me-1"></i>Restablecer contraseña sin correo
                </a>
              </div>
              <div class="row g-2 mb-2">
                <div class="col-12">
                  <a class="btn btn-outline-primary w-100 btn-sm" href="recover_user.php">
                    <i class="fas fa-user-circle me-1"></i> Recuperar usuario
                  </a>
                </div>
                <div class="col-12">
                  <a class="btn btn-outline-secondary w-100 btn-sm" href="reset_password_no_email.php">
                    <i class="fas fa-key me-1"></i> Restablecer contraseña sin correo
                  </a>
                </div>
              </div>
            ...
            <div class="text-center mt-3">
              <a href="landing.php" class="text-muted text-decoration-none small">
