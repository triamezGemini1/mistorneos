...
<div class="container-fluid py-3">
    ...
    <h1 class="h4 mb-2"><i class="fas fa-users-cog text-primary"></i> Carga automática — <?= htmlspecialchars((string)($torneo['nombre'] ?? '')) ?></h1>
    <?php
    require_once __DIR__ . '/../../lib/InscritosHelper.php';
    $contadores_inscripcion = InscritosHelper::contadoresResumenInscripcionTorneo(DB::pdo(), $torneo_id, (int) ($torneo['modalidad'] ?? 3));
