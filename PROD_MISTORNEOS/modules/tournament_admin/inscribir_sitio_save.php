...
if (empty($id_usuario) && !empty($cedula)) {
    ...
    if ($usuario_encontrado) {
        ...
        header('Location: ../../public/index.php?page=tournament_admin&torneo_id=' . $torneo_id . '&action=inscribir_sitio&error=' . urlencode('No se encontró un usuario registrado con la cédula ' . htmlspecialchars($cedula) . '. Debe registrar al usuario primero.'));
        exit;
    }
}
