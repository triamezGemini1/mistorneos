 ...
 * Ubicación: desktop/debug_db.php (ruta desktop, sin public)
 */
...
<body>
    ...
    <?php elseif (count($rows) === 0): ?>
        <p class="empty">No hay registros en la tabla. Registra un jugador desde registro_jugador.php o sincroniza desde la web.</p>
    <?php else: ?>
